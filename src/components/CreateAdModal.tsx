        ...
        <form onSubmit={handleCreateAd} className="mt-8 flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            {/* <Select.Root name="game">
              <Select.Trigger 
                aria-label="Game" 
                className="bg-zinc-900 py-3 px-4 rounded text-sm flex justify-between items-center placeholder:text-zinc-500"
              >
              ...
              <Select.Portal>
                <Select.Content className="overflow-hidden bg-zinc-800 rounded w-60 text-white">
                  <Select.ScrollUpButton>
                    <CaretUp />
                  </Select.ScrollUpButton>
                  <Select.Viewport>
                    <Select.SelectItem className="flex justify-between p-3 hover:bg-violet-600" value="apple">
                      <Select.SelectItemText>Apple</Select.SelectItemText>
                      <Select.SelectItemIndicator>
                        <Check />
                      </Select.SelectItemIndicator>
                    </Select.SelectItem>
                    <Select.SelectItem className="flex justify-between p-3 hover:bg-violet-600" value="pineapple">
                      <Select.SelectItemText>Pineapple</Select.SelectItemText>
                      <Select.SelectItemIndicator>
                        <Check />
                      </Select.SelectItemIndicator>
                    </Select.SelectItem>
                    <Select.SelectItem className="flex justify-between p-3 hover:bg-violet-600" value="watermelon">
                      <Select.SelectItemText>Watermelon</Select.SelectItemText>
                      <Select.SelectItemIndicator>
                        <Check />
                      </Select.SelectItemIndicator>
                    </Select.SelectItem>
                    <Select.SelectItem className="flex justify-between p-3 hover:bg-violet-600" value="orange">
